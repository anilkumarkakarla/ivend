...
namespace CXS.Api.BusinessObjects
{
    ...
    public IActionResult CreatePurchaseOrderDetails(PurPurchaseOrder _objPurchaseOrder)
       ...
       public IActionResult UpdatePurchaseOrderDetails(long purchaseOrderKey, PurPurchaseOrder _objPurchaseOrder)
        {
           try
            {
        ...
        public IEnumerable<PurPurchaseOrder> GetPurchaseOrderByAll(PurPurchaseOrder purchaseOrder,string searchOperator)
        {
           var purchaseOrderDetails = new List<PurPurchaseOrder>();
            try
            {
